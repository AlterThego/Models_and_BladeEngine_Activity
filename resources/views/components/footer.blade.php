<footer class="bottom-0 relative py-10 flex flex-col items-center bg-cyan-900 overflow-hidden md:py-20">
        ...
        <div class="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                ...
                <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                    <span class="block text-gray-300">CIT18 | MASTERY IN WEB TECHNOLOGY</span>

                    <span class="block text-gray-300">AlterThego &copy; {{ date('Y') }}</span>
                </div>
            </div>
        </div>
    </div>
